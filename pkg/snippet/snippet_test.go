...
func ExampleIdentFor() {
	...
	Print(
		ctx,
		Poster("demo", "genx:test_ident", "devel"),
		Imports(ctx),
		body,
	)

	// Output:
	// // Code generated by genx:test_ident@devel DO NOT EDIT.
	// package demo
	//
	// import (
	// 	"bytes"
...
func ExampleExpose() {
	...
	Print(
		ctx,
		Poster("demo", "genx:test_expose", "devel"),
		Imports(ctx),
		body,
	)

	// Output:
	// // Code generated by genx:test_expose@devel DO NOT EDIT.
	// package demo
	//
	// import (
	// 	"errors"
...
func ExampleTemplate() {
	...
	Write(
		ctx,
		b,
		Poster("testdata", "genx:test_template", "devel"),
		Imports(ctx),
		tpl,
	)
...
func ExampleValue() {
	...
	Print(
		ctx,
		Poster("demo", "genx:test_value", "devel"),
		Imports(ctx),
		body,
	)

	// Output:
	// // Code generated by genx:test_value@devel DO NOT EDIT.
	// package demo
	//
	// import (
	// 	"github.com/xoctopus/x/ptrx"
